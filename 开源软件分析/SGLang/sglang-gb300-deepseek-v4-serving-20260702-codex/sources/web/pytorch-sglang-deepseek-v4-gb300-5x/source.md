...
- Source URL: https://pytorch.org/blog/serving-deepseek-v4-on-gb300-with-sglang-5x-higher-throughput-at-the-same-interactivity-since-day-0/
- Publisher/Site: PyTorch
- Author: Not specified in captured page metadata
- Published date: Not specified in captured page metadata
- Modified date: Not specified in captured page metadata
- Captured date: 2026-07-02
- Capture mode: rendered capture via Codex in-app Browser

## Capture Notes

- Body boundary: captured the rendered article scope `article#post-114500`, starting at the article hero image/TL;DR and ending at the in-article Acknowledgements section. No related-post, navigation, newsletter, footer, or recommendation modules were included.
- Media summary: kept 3正文 images: the article hero image and two performance-result chart images. No visible正文 image candidates were rejected. The page did not expose explicit figure captions, so captions below use alt text / nearby section context.
- Browser recovery: first navigation timed out; retry in a fresh tab loaded successfully and was used for extraction.

## Article Text

![Serving DeepSeek-V4 on GB300 with SGLang: 5x Higher Throughput at the Same Interactivity Since Day-0](images/image-01.webp)

Original image URL: https://pytorch.org/wp-content/uploads/2026/06/Serving-DeepSeek-V4-on-GB300-with-SGLang-5x-Higher-Throughput-at-the-Same-Interactivity-Since-Day-0-image.png

Caption/nearby text: Serving DeepSeek-V4 on GB300 with SGLang: 5x Higher Throughput at the Same Interactivity Since Day-0
...
![DeepSeek V4 Pro on NVIDIA GB300](images/image-02.webp)

Original image URL: https://pytorch.org/wp-content/uploads/2026/06/sglang-dsv4-gb300-disagg-8k1k.png

Caption/nearby text: DeepSeek V4 Pro on NVIDIA GB300
...
![DeepSeek-V4 Pro on NVIDIA Blackwell Ultra](images/image-03.webp)

Original image URL: https://pytorch.org/wp-content/uploads/2026/06/sglang-dsv4-blackwell-agg-8k1k.png

Caption/nearby text: DeepSeek-V4 Pro on NVIDIA Blackwell Ultra
