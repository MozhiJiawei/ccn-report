...
- [PipeLive-流水线在线重配置.html](./PipeLive-流水线在线重配置.html)：dependency-free SingleFile Source Understanding HTML，可离线打开。
- [PipeLive-流水线在线重配置.pptx](./PipeLive-流水线在线重配置.pptx)：基于已验收 HTML 总结的一页式可编辑技术洞察 PPTX。
