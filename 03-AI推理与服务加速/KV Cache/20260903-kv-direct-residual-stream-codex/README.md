...
- [KV-Direct-残差流KV传输.html](./KV-Direct-残差流KV传输.html)：dependency-free SingleFile Source Understanding HTML，可离线打开。
- [KV-Direct-残差流KV传输.pptx](./KV-Direct-残差流KV传输.pptx)：基于已验收 HTML 总结的一页式可编辑技术洞察 PPTX。
