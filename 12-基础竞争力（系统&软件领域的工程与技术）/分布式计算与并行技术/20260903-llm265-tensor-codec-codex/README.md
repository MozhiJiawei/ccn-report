...
- [LLM.265-张量视频编码.html](./LLM.265-张量视频编码.html)：dependency-free SingleFile Source Understanding HTML，可离线打开。
- [LLM.265-张量视频编码.pptx](./LLM.265-张量视频编码.pptx)：基于已验收 HTML 总结的一页式可编辑技术洞察 PPTX。
