...
- [FourierCompress-频域激活压缩.html](./FourierCompress-频域激活压缩.html)：dependency-free SingleFile Source Understanding HTML，可离线打开。
- [FourierCompress-频域激活压缩.pptx](./FourierCompress-频域激活压缩.pptx)：基于已验收 HTML 总结的一页式可编辑技术洞察 PPTX。
