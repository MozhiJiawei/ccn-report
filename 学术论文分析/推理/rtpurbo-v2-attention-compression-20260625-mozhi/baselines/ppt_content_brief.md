...
参考图片：
- ![Figure 4: RTPurbo overall architecture](D:\Agent Repo\Mozhi-s-AgentWorkspace\.tmp\ppt-deep-search\ptrurbov2-attention-compression\review\assets\fig4-architecture.png)
- ![Figure 6: Ultra-long multi-hop accuracy and sparsity](D:\Agent Repo\Mozhi-s-AgentWorkspace\.tmp\ppt-deep-search\ptrurbov2-attention-compression\review\assets\fig6-ultralong.png)
- ![Figure 7: Sparse decoding speedup](D:\Agent Repo\Mozhi-s-AgentWorkspace\.tmp\ppt-deep-search\ptrurbov2-attention-compression\review\assets\fig7-speedup.png)
- ![Table 4: RULER accuracy comparison](D:\Agent Repo\Mozhi-s-AgentWorkspace\.tmp\ppt-deep-search\ptrurbov2-attention-compression\review\assets\table4-ruler.png)
- ![Table 5: Reasoning benchmark accuracy](D:\Agent Repo\Mozhi-s-AgentWorkspace\.tmp\ppt-deep-search\ptrurbov2-attention-compression\review\assets\table5-reasoning.png)
备注：
